...
function changeContent(title, content, buttonConfigs = []) {
    ...
    const hiden = document.getElementById('contentDATE');
        ...
        <div class="row filter-date123">
            ...
            <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                ...
                <button type="button" class="btn btn-primary" id="filterButton" onclick="filterByDate()">Lọc</button>
            </div>
